...
SEXP cairo_set_source_(SEXP cr_, SEXP source_)  {
  cairo_t *cr = isNull(cr_) ? NULL : (cairo_t *)R_ExternalPtrAddr(cr_);
  if (cr == NULL) error("'cairo_t * cr' pointer is invalid/NULL");
  cairo_pattern_t *source = isNull(source_) ? NULL : (cairo_pattern_t *)R_ExternalPtrAddr(source_);
...
SEXP cairo_font_extents_(SEXP cr_, SEXP extents_)  {
  cairo_t *cr = isNull(cr_) ? NULL : (cairo_t *)R_ExternalPtrAddr(cr_);
  if (cr == NULL) error("'cairo_t * cr' pointer is invalid/NULL");
  cairo_font_extents_t *extents = isNull(extents_) ? NULL : (cairo_font_extents_t *)R_ExternalPtrAddr(extents_);
...
SEXP cairo_text_extents_(SEXP cr_, SEXP utf8_, SEXP extents_)  {
  ...
  cairo_text_extents_t *extents = isNull(extents_) ? NULL : (cairo_text_extents_t *)R_ExternalPtrAddr(extents_);
...
SEXP cairo_append_path_(SEXP cr_, SEXP path_)  {
  cairo_t *cr = isNull(cr_) ? NULL : (cairo_t *)R_ExternalPtrAddr(cr_);
  if (cr == NULL) error("'cairo_t * cr' pointer is invalid/NULL");
  cairo_path_t *path = isNull(path_) ? NULL : (cairo_path_t *)R_ExternalPtrAddr(path_);
