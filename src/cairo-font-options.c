...
SEXP cairo_font_options_copy_(SEXP original_)  {
  cairo_font_options_t *original = isNull(original_) ? NULL : (cairo_font_options_t *)R_ExternalPtrAddr(original_);
...
SEXP cairo_font_options_status_(SEXP options_)  {
  cairo_font_options_t *options = isNull(options_) ? NULL : (cairo_font_options_t *)R_ExternalPtrAddr(options_);
...
SEXP cairo_font_options_merge_(SEXP options_, SEXP other_)  {
  cairo_font_options_t *options = isNull(options_) ? NULL : (cairo_font_options_t *)R_ExternalPtrAddr(options_);
  if (options == NULL) error("'cairo_font_options_t * options' pointer is invalid/NULL");
  cairo_font_options_t *other = isNull(other_) ? NULL : (cairo_font_options_t *)R_ExternalPtrAddr(other_);
