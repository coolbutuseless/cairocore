...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_status_t <- list(
  CAIRO_STATUS_SUCCESS                   =    0L,
  CAIRO_STATUS_NO_MEMORY                 =    1L,
  CAIRO_STATUS_INVALID_RESTORE           =    2L,
  CAIRO_STATUS_INVALID_POP_GROUP         =    3L,
  CAIRO_STATUS_NO_CURRENT_POINT          =    4L,
  CAIRO_STATUS_INVALID_MATRIX            =    5L,
  CAIRO_STATUS_INVALID_STATUS            =    6L,
  CAIRO_STATUS_NULL_POINTER              =    7L,
  CAIRO_STATUS_INVALID_STRING            =    8L,
  CAIRO_STATUS_INVALID_PATH_DATA         =    9L,
  CAIRO_STATUS_READ_ERROR                =   10L,
  CAIRO_STATUS_WRITE_ERROR               =   11L,
  CAIRO_STATUS_SURFACE_FINISHED          =   12L,
  CAIRO_STATUS_SURFACE_TYPE_MISMATCH     =   13L,
  CAIRO_STATUS_PATTERN_TYPE_MISMATCH     =   14L,
  CAIRO_STATUS_INVALID_CONTENT           =   15L,
  CAIRO_STATUS_INVALID_FORMAT            =   16L,
  CAIRO_STATUS_INVALID_VISUAL            =   17L,
  CAIRO_STATUS_FILE_NOT_FOUND            =   18L,
  CAIRO_STATUS_INVALID_DASH              =   19L,
  CAIRO_STATUS_INVALID_DSC_COMMENT       =   20L,
  CAIRO_STATUS_INVALID_INDEX             =   21L,
  CAIRO_STATUS_CLIP_NOT_REPRESENTABLE    =   22L,
  CAIRO_STATUS_TEMP_FILE_ERROR           =   23L,
  CAIRO_STATUS_INVALID_STRIDE            =   24L,
  CAIRO_STATUS_FONT_TYPE_MISMATCH        =   25L,
  CAIRO_STATUS_USER_FONT_IMMUTABLE       =   26L,
  CAIRO_STATUS_USER_FONT_ERROR           =   27L,
  CAIRO_STATUS_NEGATIVE_COUNT            =   28L,
  CAIRO_STATUS_INVALID_CLUSTERS          =   29L,
  CAIRO_STATUS_INVALID_SLANT             =   30L,
  CAIRO_STATUS_INVALID_WEIGHT            =   31L,
  CAIRO_STATUS_INVALID_SIZE              =   32L,
  CAIRO_STATUS_USER_FONT_NOT_IMPLEMENTED =   33L,
  CAIRO_STATUS_DEVICE_TYPE_MISMATCH      =   34L,
  CAIRO_STATUS_DEVICE_ERROR              =   35L,
  CAIRO_STATUS_INVALID_MESH_CONSTRUCTION =   36L,
  CAIRO_STATUS_DEVICE_FINISHED           =   37L,
  CAIRO_STATUS_JBIG2_GLOBAL_MISSING      =   38L,
  CAIRO_STATUS_PNG_ERROR                 =   39L,
  CAIRO_STATUS_FREETYPE_ERROR            =   40L,
  CAIRO_STATUS_WIN32_GDI_ERROR           =   41L,
  CAIRO_STATUS_TAG_ERROR                 =   42L,
  CAIRO_STATUS_LAST_STATUS               =   43L
)
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_content_t <- list(
  CAIRO_CONTENT_COLOR		    = 0x1000L,
  CAIRO_CONTENT_ALPHA		    = 0x2000L,
  CAIRO_CONTENT_COLOR_ALPHA	= 0x3000L
)
...
#' \item{CAIRO_FORMAT_RGB96F}{3 floats, R, G, B. (Since 1.17.2)}
#' \item{CAIRO_FORMAT_RGBA128F}{4 floats, R, G, B, A. (Since 1.17.2)}
#' }
#'
#' @export
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_format_t <- list(
  CAIRO_FORMAT_INVALID   = -1L,
  CAIRO_FORMAT_ARGB32    =  0L,  # 4 bytes
  CAIRO_FORMAT_RGB24     =  1L,  # 4 bytes. Lower 3 bytes only
  CAIRO_FORMAT_A8        =  2L,  # alpha byte
  CAIRO_FORMAT_A1        =  3L,  # alpha bit. 32bits packed into a long int
  CAIRO_FORMAT_RGB16_565 =  4L,  # 2 bytes
  CAIRO_FORMAT_RGB30     =  5L,  # 10bits per channel
  CAIRO_FORMAT_RGB96F    =  6L,  # 3 floats (32 bit floating point) = 96 bits
  CAIRO_FORMAT_RGBA128F  =  7L   # 4 floats (32 bit floating point) = 128 bits
)
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_operator_t <- list(
  CAIRO_OPERATOR_CLEAR          =  0L,
  CAIRO_OPERATOR_SOURCE         =  1L,
  CAIRO_OPERATOR_OVER           =  2L,
  CAIRO_OPERATOR_IN             =  3L,
  CAIRO_OPERATOR_OUT            =  4L,
  CAIRO_OPERATOR_ATOP           =  5L,
  CAIRO_OPERATOR_DEST           =  6L,
  CAIRO_OPERATOR_DEST_OVER      =  7L,
  CAIRO_OPERATOR_DEST_IN        =  8L,
  CAIRO_OPERATOR_DEST_OUT       =  9L,
  CAIRO_OPERATOR_DEST_ATOP      = 10L,
  CAIRO_OPERATOR_XOR            = 11L,
  CAIRO_OPERATOR_ADD            = 12L,
  CAIRO_OPERATOR_SATURATE       = 13L,
  CAIRO_OPERATOR_MULTIPLY       = 14L,
  CAIRO_OPERATOR_SCREEN         = 15L,
  CAIRO_OPERATOR_OVERLAY        = 16L,
  CAIRO_OPERATOR_DARKEN         = 17L,
  CAIRO_OPERATOR_LIGHTEN        = 18L,
  CAIRO_OPERATOR_COLOR_DODGE    = 19L,
  CAIRO_OPERATOR_COLOR_BURN     = 20L,
  CAIRO_OPERATOR_HARD_LIGHT     = 21L,
  CAIRO_OPERATOR_SOFT_LIGHT     = 22L,
  CAIRO_OPERATOR_DIFFERENCE     = 23L,
  CAIRO_OPERATOR_EXCLUSION      = 24L,
  CAIRO_OPERATOR_HSL_HUE        = 25L,
  CAIRO_OPERATOR_HSL_SATURATION = 26L,
  CAIRO_OPERATOR_HSL_COLOR      = 27L,
  CAIRO_OPERATOR_HSL_LUMINOSITY = 28L
)
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_antialias_t <- list(
  CAIRO_ANTIALIAS_DEFAULT   = 0L,

  # /* method */
  CAIRO_ANTIALIAS_NONE      = 1L,
  CAIRO_ANTIALIAS_GRAY      = 2L,
  CAIRO_ANTIALIAS_SUBPIXEL  = 3L,

  # /* hints */
  CAIRO_ANTIALIAS_FAST      = 4L,
  CAIRO_ANTIALIAS_GOOD      = 5L,
  CAIRO_ANTIALIAS_BEST      = 6L
)
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_fill_rule_t <- list(
  CAIRO_FILL_RULE_WINDING  = 0L,
  CAIRO_FILL_RULE_EVEN_ODD = 1L
)
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_line_cap_t <- list(
  CAIRO_LINE_CAP_BUTT   = 0L,
  CAIRO_LINE_CAP_ROUND  = 1L,
  CAIRO_LINE_CAP_SQUARE = 2L
)
...
#'
#' \describe{
#' \item{CAIRO_LINE_JOIN_MITER}{use a sharp (angled) corner, see cairo_set_miter_limit() (Since 1.0)}
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_line_join_t <- list(
  CAIRO_LINE_JOIN_MITER = 0L,
  CAIRO_LINE_JOIN_ROUND = 1L,
  CAIRO_LINE_JOIN_BEVEL = 2L
)
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_text_cluster_flags_t <- list(
  CAIRO_TEXT_CLUSTER_FLAG_BACKWARD = 0x00000001L
)
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_font_slant_t <- list(
  CAIRO_FONT_SLANT_NORMAL  = 0L,
  CAIRO_FONT_SLANT_ITALIC  = 1L,
  CAIRO_FONT_SLANT_OBLIQUE = 2L
)
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_font_weight_t <- list(
  CAIRO_FONT_WEIGHT_NORMAL = 0L,
  CAIRO_FONT_WEIGHT_BOLD   = 1L
)
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_subpixel_order_t <- list(
  CAIRO_SUBPIXEL_ORDER_DEFAULT = 0L,
  CAIRO_SUBPIXEL_ORDER_RGB     = 1L,
  CAIRO_SUBPIXEL_ORDER_BGR     = 2L,
  CAIRO_SUBPIXEL_ORDER_VRGB    = 3L,
  CAIRO_SUBPIXEL_ORDER_VBGR    = 4L
)
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_hint_style_t <- list(
  CAIRO_HINT_STYLE_DEFAULT = 0L,
  CAIRO_HINT_STYLE_NONE    = 1L,
  CAIRO_HINT_STYLE_SLIGHT  = 2L,
  CAIRO_HINT_STYLE_MEDIUM  = 3L,
  CAIRO_HINT_STYLE_FULL    = 4L
)
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_hint_metrics_t <- list(
  CAIRO_HINT_METRICS_DEFAULT = 0L,
  CAIRO_HINT_METRICS_OFF     = 1L,
  CAIRO_HINT_METRICS_ON      = 2L
)
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_font_type_t <- list(
  CAIRO_FONT_TYPE_TOY    = 0L,
  CAIRO_FONT_TYPE_FT     = 1L,
  CAIRO_FONT_TYPE_WIN32  = 2L,
  CAIRO_FONT_TYPE_QUARTZ = 3L,
  CAIRO_FONT_TYPE_USER   = 4L
)
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_path_data_type_t <- list(
  CAIRO_PATH_MOVE_TO    = 0L,
  CAIRO_PATH_LINE_TO    = 1L,
  CAIRO_PATH_CURVE_TO   = 2L,
  CAIRO_PATH_CLOSE_PATH = 3L
)
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_device_type_t <- list(
  CAIRO_DEVICE_TYPE_DRM     =  0L,
  CAIRO_DEVICE_TYPE_GL      =  1L,
  CAIRO_DEVICE_TYPE_SCRIPT  =  2L,
  CAIRO_DEVICE_TYPE_XCB     =  3L,
  CAIRO_DEVICE_TYPE_XLIB    =  4L,
  CAIRO_DEVICE_TYPE_XML     =  5L,
  CAIRO_DEVICE_TYPE_COGL    =  6L,
  CAIRO_DEVICE_TYPE_WIN32   =  7L,
  CAIRO_DEVICE_TYPE_INVALID = -1L
)
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_surface_observer_mode_t <- list(
  CAIRO_SURFACE_OBSERVER_NORMAL            = 0L,
  CAIRO_SURFACE_OBSERVER_RECORD_OPERATIONS = 0x1L
)
...
#' \item{CAIRO_SURFACE_TYPE_SUBSURFACE}{The surface is a subsurface created with cairo_surface_create_for_rectangle(), since 1.10}
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_surface_type_t <- list(
  CAIRO_SURFACE_TYPE_IMAGE           =  0L,
  CAIRO_SURFACE_TYPE_PDF             =  1L,
  CAIRO_SURFACE_TYPE_PS              =  2L,
  CAIRO_SURFACE_TYPE_XLIB            =  3L,
  CAIRO_SURFACE_TYPE_XCB             =  4L,
  CAIRO_SURFACE_TYPE_GLITZ           =  5L,
  CAIRO_SURFACE_TYPE_QUARTZ          =  6L,
  CAIRO_SURFACE_TYPE_WIN32           =  7L,
  CAIRO_SURFACE_TYPE_BEOS            =  8L,
  CAIRO_SURFACE_TYPE_DIRECTFB        =  9L,
  CAIRO_SURFACE_TYPE_SVG             = 10L,
  CAIRO_SURFACE_TYPE_OS2             = 11L,
  CAIRO_SURFACE_TYPE_WIN32_PRINTING  = 12L,
  CAIRO_SURFACE_TYPE_QUARTZ_IMAGE    = 13L,
  CAIRO_SURFACE_TYPE_SCRIPT          = 14L,
  CAIRO_SURFACE_TYPE_QT              = 15L,
  CAIRO_SURFACE_TYPE_RECORDING       = 16L,
  CAIRO_SURFACE_TYPE_VG              = 17L,
  CAIRO_SURFACE_TYPE_GL              = 18L,
  CAIRO_SURFACE_TYPE_DRM             = 19L,
  CAIRO_SURFACE_TYPE_TEE             = 20L,
  CAIRO_SURFACE_TYPE_XML             = 21L,
  CAIRO_SURFACE_TYPE_SKIA            = 22L,
  CAIRO_SURFACE_TYPE_SUBSURFACE      = 23L,
  CAIRO_SURFACE_TYPE_COGL            = 24L
)
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_pattern_type_t <- list(
  CAIRO_PATTERN_TYPE_SOLID         = 0L,
  CAIRO_PATTERN_TYPE_SURFACE       = 1L,
  CAIRO_PATTERN_TYPE_LINEAR        = 2L,
  CAIRO_PATTERN_TYPE_RADIAL        = 3L,
  CAIRO_PATTERN_TYPE_MESH          = 4L,
  CAIRO_PATTERN_TYPE_RASTER_SOURCE = 5L
)
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_extend_t <- list(
  CAIRO_EXTEND_NONE    = 0L,
  CAIRO_EXTEND_REPEAT  = 1L,
  CAIRO_EXTEND_REFLECT = 2L,
  CAIRO_EXTEND_PAD     = 3L
)
...
#'
#' \describe{
#' \item{CAIRO_FILTER_FAST}{A high-performance filter, with quality similar to \%CAIRO_FILTER_NEAREST (Since 1.0)}
#' \item{CAIRO_FILTER_GOOD}{A reasonable-performance filter, with quality similar to \%CAIRO_FILTER_BILINEAR (Since 1.0)}
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_filter_t <- list(
  CAIRO_FILTER_FAST     = 0L,
  CAIRO_FILTER_GOOD     = 1L,
  CAIRO_FILTER_BEST     = 2L,
  CAIRO_FILTER_NEAREST  = 3L,
  CAIRO_FILTER_BILINEAR = 4L,
  CAIRO_FILTER_GAUSSIAN = 5L
)
...
#' @family enum
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
cairo_region_overlap_t <- list(
    CAIRO_REGION_OVERLAP_IN   = 0L,		# completely inside region
    CAIRO_REGION_OVERLAP_OUT  = 1L,		# completely outside region
    CAIRO_REGION_OVERLAP_PART = 2L		# partly inside region
)
